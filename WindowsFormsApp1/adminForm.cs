    ...
    public partial class adminForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (signUIsValid())
            {
                ...
                string emailBody = "Hi " + firtNameTextBox + ",\n " +
                                   "We're happy you signed up for The Cottage BNB. To start making bookings on the cottage booking app please confirm you, " +
                                   "Please confirm your email address." +
                                   "\n\nHere's your One Time Pin(OTP)" + temp + "\n\nThis is an autogenerated email, for enquiries" +
                                   "\ncall: +27 64 090 3388" +
                                   "\nOr email: sonya@TheCottageBnB.co.za";
        ...
        {
            string temp = randomOTP();
            string emailBody = "Hi " + firtNameTextBox.Text + ",\n " +
                               "We're happy you signed up for The Cottage BNB. To start making bookings on the cottage booking app please confirm you, " +
                               "Please confirm your email address." +"\n\nHere's your One Time Pin(OTP)" + 
                               temp + "\n\nThis is an autogenerated email, for enquiries"+
                               "\ncall: +27 64 090 3388"+
                               "\nOr email: sonya@TheCottageBnB.co.za";
            Email.sendEmail(emailTextBox.Text, "Email Confirmation", emailBody);
