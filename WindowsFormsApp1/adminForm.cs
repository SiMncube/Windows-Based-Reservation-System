...
namespace WindowsFormsApp1
{
    public partial class adminForm : Form
    {
        ...
        private string htmlOTP(string temp)
        {
            return @"<html>
                    <body>
                    <p> Dear <var>firtNameTextBox.Text</var>,</p>
                    <p>We're happy you signed up for The Cottage BNB. To start making bookings on the cottage booking app, Please confirm your email address</p>
                    <p>Here's your One Time Pin(OTP) : <var>temp</var></p>
                    <p>This is an autogenerated email, for enquiries<br>call: +27 64 090 3388<br>Or email: sonya@TheCottageBnB.co.za</p>
                    </body>
                    </html>";
        }
