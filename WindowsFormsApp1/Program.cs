...
namespace WindowsFormsApp1
{
    public class Email
    {
        ...
        public static string invoiceBody()  //this method will just creating some structure for the booking invoice email
        {
            ...
            if (isBankingDetails)
            {
                messageBody += "<font> Here Is Uur Banking Details, Where you could make your payment </font><br><br>";
                messageBody += "<font> Bank Name: Standard Bank </font><br><br>";
                messageBody += "<font> Account Holder: The Cottage BnB </font><br><br>";
                messageBody += "<font> Account Number: 4564864648 </font><br><br>";
                messageBody += "<font> Branch Code: 45684 </font><br><br>";
