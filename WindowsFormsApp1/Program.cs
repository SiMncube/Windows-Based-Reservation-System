...
namespace WindowsFormsApp1
{
    public class Email
    {
        ...
        { 
            ...
            else if (isBankingDetails)
            {
                send(customerEmail, "The Cottage BNB, Reservation Invoice With Payment Details", invoiceBody());
                isBankingDetails = false;
            }
            else
        ...
        public static string invoiceBody()  //this method will just creating some structure for the booking invoice email
        {
            ...
            {
                messageBody += "<font> To Finalize your Reservations, Please make a payment to the attached banking details.</font><br><br>";
                messageBody += "<font> Here Is Your Invoice, We're Looking Forward To Having You As Our Guest.</font><br><br>";
            }
            else
            {
            ...
            if (isBankingDetails)
            {
                messageBody += "<font> Here Is Our Banking Details, Where you will make your payment </font><br>";
                messageBody += "<font> Bank Name: Standard Bank </font><br>";
                messageBody += "<font> Account Holder: The Cottage BnB </font><br>";
                messageBody += "<font> Account Number: 4564864648 </font><br>";
                messageBody += "<font> Branch Code: 45684 </font><br>";
                messageBody += "<font> Please Use your booking reference for payment reference </font><br><br>";
            }
        ...
        public static bool isBankingDetails = false;
    }
