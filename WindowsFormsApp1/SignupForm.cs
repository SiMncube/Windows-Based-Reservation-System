...
namespace WindowsFormsApp1
{
    public partial class SignupForm : Form
    {
        ...
        {
                Email.sendEmail(textBox7.Text, "Welcome to The Cottage BnB", htmlWelcome());
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if(signUIsValid())
            {
                ...
                Email.sendEmail(textBox7.Text, "Sign up OTP confirmation",htmlOTP(temp));
        ...
        private string htmlOTP(string temp)
        {
            string body = @"<html>
                           <body>";
            body += "<p>Dear " + textBox1.Text + ",</p><p>We're happy you signed up for The Cottage BNB. To start making bookings on the cottage booking app, Please confirm your email address</p>";
        ...
        private string htmlWelcome()
        {
            string body = @"<html>
                           <body>";
            body += "<h1>Welcome to The Cottage BnB, " + textBox1.Text + "!</h1><p><strong>This email includes your account details, so please keep it safe.</strong></p><p>We’re thrilled to see you here!</p>";
